        ...
        <Container>
            <header className="header" style={{ backgroundColor: `${colorChange ? 'white' : 'transparent'}` }}>
                ...
                <ul className="menu">
                    ...
                    <li><div className='resumeBox'><a className='resume' href="https://drive.google.com/file/d/1wlhc5UAjnj_QaZ_giM6T37g7WOmq3rnA/view?usp=sharing" target='_blank' rel='noreferrer'>
                        Resume<DownloadIcon />
                    </a></div></li>
                </ul>
            </header>

        ...
        <Container>
            <header className="header" style={{ backgroundColor: `${colorChange ? 'white' : 'transparent'}` }}>
                ...
                <ul className="menu">
                    ...
                    <li><div className='resumeBox'><a className='resume' href="https://drive.google.com/file/d/1RpvBVii98j_0jTgEKDHzEl_pW587-23o/view?usp=share_link" target='_blank' rel='noreferrer'>
                        Resume<DownloadIcon />
                    </a></div></li>
                </ul>
            </header>

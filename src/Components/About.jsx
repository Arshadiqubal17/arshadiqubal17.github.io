...
import myImage from '../Resources/Images/profilePic.png'
import backgroundImage from '../Resources/Images/backgroundHome.jpg';
import signature from '../Resources/Images/signature.jpg';
            ...
            <Container>
                <div className='aboutBox'>
                    <div className='about_leftBox'>
                        ...
                        <a href="https://drive.google.com/uc?export=download&id=1RpvBVii98j_0jTgEKDHzEl_pW587-23o">
            ...
            <AboutMeWrapper>
                <div className='aboutSection'>
                    <div className='left'>
                        ...
                        <p></p>
                        <p>Email: <span>arshad.iqubal17@yahoo.in</span></p>
                        <p>Language: <span>English</span></p>
                        <p>Nationality: <span>Indian</span></p>
                    </div>
                    <div className='right'>
                        <h2>I am <span>Full Stack Web Developer</span></h2>
                        <p>My name is Arshad Iqubal, I am from Muzaffarpur, BIHAR. Passionate Full Stack Web Developer
                            ...
                            company growth..</p>
                        {/* <div>
                            <img src={signature} alt='Arshad_Signature' width='360px' height='80px' />
                        </div> */}
                    </div>
                </div>
            </AboutMeWrapper>

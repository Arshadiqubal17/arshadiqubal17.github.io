    ...
    return (
        <Container id='contact'>
                ...
                <div className='contactText'>
                    ...
                    <div className='middleSection'>
                        <div>
                            ...
                            <a href="https://www.linkedin.com/in/arshad-iqubal/" rel="noreferrer" target="_blank">
                                <p>arshad-iqubal</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href="tel:+917979781567" rel="noreferrer" target="_blank">
                                <p>+917979781567</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href='mailto:arshad.iqbal17@yahoo.in' rel="noreferrer" target="_blank"><p>arshad.iqbal17@yahoo.in</p></a>
                        </div>
                        <div>
                            <LocationOnIcon fontSize="large" />
                            <h1>Location</h1>
                            <p>Muzaffarpur,Bihar</p>
                            <a href="https://www.google.com/maps/place/Muzaffarpur,+Bihar/@26.1205879,85.3162957,12z/data=!3m1!4b1!4m6!3m5!1s0x39ed10e8a3175529:0x7c2d919680f759d!8m2!3d26.1196607!4d85.390982!16zL20vMDVwbmht" rel="noreferrer" target="_blank">
            ...
            <div className='endSection'>
                <p>© 2022 Arshad. Design by Me with <FavoriteIcon sx={{ color: '#01a479' }} /></p>
            </div>
        </Container>
    )
}
